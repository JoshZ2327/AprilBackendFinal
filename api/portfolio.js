...
export default async function handler(req, res) {
    try {
        ...
        // Fallback: Use the simple response to avoid crashing
        console.log("Portfolio endpoint fallback triggered");
        ...
        return res.status(500).json({
            ...
            fallback: "Portfolio endpoint is working with fallback!",
        });
    }
}
...
We need to add this code to the snippet you just printed for portfolio.js so the server doesn’t crash
